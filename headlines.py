...
WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&APPID=3f0d4d79c48ce67a2b1904c4bdb29a39"
CURRENCY_URL = "https://openexchangerates.org//api/latest.json?app_id=f34565f90481432b90bd22b966cffbd8"

DEFAULTS = {'publication': 'lenta',
            'city': 'Chishinau, MD',
            'currency_from': 'RUB',
            'currency_to': 'MDL'
            }
